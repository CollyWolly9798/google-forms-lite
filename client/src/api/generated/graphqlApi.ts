...
export type CreateFormMutationVariables = Exact<{
  ...
  questions?: InputMaybe<
    Array<InputMaybe<QuestionInput>> | InputMaybe<QuestionInput>
  >;
}>;
...
export type SubmitResponseMutation = {
  __typename?: 'Mutation';
  submitResponse: { __typename?: 'Response'; id: string };
};
...
export type ResponsesQuery = {
  ...
  responses: Array<{
    __typename?: 'Response';
    id: string;
    answers: Array<{ __typename?: 'Answer'; questionId: string; text: string }>;
  }>;
};
